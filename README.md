...
Este é um projeto de **landing page** simples sobre o layout de um site sobre análise de dados, desenvolvido com **HTML** e **CSS**, destinado a aprender e praticar os conceitos básicos de desenvolvimento web.
...
- **Estrutura HTML**: Utilização de tags básicas como `<header>`, `<section>`, `<main>`, `<main>`, entre outras.
...
<img src="./resultados-preview/Macbook-Air-1559x975.png" style="display: block; margin: auto;">

### Versão Mobile

<img src="./resultados-preview/iPhone-14-Pro-Max-430x932.png" style="display: block; margin: auto;">
<br>

<p><a href="https://inocenciooo.github.io/stats-preview-card-component-main/" target="_blanck">Acesse aqui</a> para visualizar o projeto no <strong>GitHub Pages</strong> com mais detalhes!</p>
